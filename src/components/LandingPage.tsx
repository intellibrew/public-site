...
const LandingPage = () => {
  ...
  const handleLoginClick = () => {
    window.location.href = 'https://app.neofab.ai/login';
  };
        ...
        <nav className="z-20 relative flex flex-wrap sm:flex-nowrap items-center justify-between px-4 sm:px-6 py-4 max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-2 sm:mt-0 text-sm sm:text-base">
            <button
              ...
              className="hover:text-white/80 cursor-pointer bg-transparent border-none text-white text-sm sm:text-base"
            >
              About Us
            </button>
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              ...
              >
                ...
                <a
                  ...
                  className="inline-block bg-white text-[#203a43] hover:bg-white/90 px-6 lg:px-8 py-3 lg:py-4 text-base lg:text-lg font-semibold rounded transition-all duration-200 hover:shadow-lg"
                >
                  Get Started
                </a>
              </motion.div>
