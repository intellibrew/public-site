...
export default function FactoryContactCue() {
  return (
    <a
      ...
      className="factory-contact-cue factory-website-flow-ui inline-flex min-w-0 items-center gap-2 font-body text-[12px] text-slate-400/90 transition-colors hover:text-teal-400/95 sm:text-[13px]"
